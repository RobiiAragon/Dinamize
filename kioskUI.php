...
// Obtener la lista de negocios de la plaza del usuario actual
$sql = "SELECT * FROM negocios WHERE plaza_id = ?";
$stmt = $conn->prepare($sql);
    ...
    <div class="dashboard-container">
        <aside class="sidebar">
            ...
            <ul>
                ...
                <li><a href="kioskUI.php" data-section="kiosk-ui" class="active">Assign Locals</a></li>
        ...
        <main class="main-content">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" preserveAspectRatio="xMidYMin meet">
                ...
                $conn = OpenCon();
                for ($i = 1; $i <= 13; $i++) {
                    $sql = "SELECT * FROM negocios WHERE NumeroLocal = ? AND plaza_id = ?";
                    $stmt_local = $conn->prepare($sql);
                    $stmt_local->bind_param("ii", $i, $plaza_id);
                    $stmt_local->execute();
                    $result_local = $stmt_local->get_result();
                    ?>
                    <g id="local<?= $i ?>" class="local-clickable" style="cursor: pointer">
                        <?php
                        // Definir el elemento SVG según el local
                        switch($i) {
                            case 1:
                                echo '<polygon class="cls-1" points="3.29 5.6 108.11 5.6 110.15 155.21 3.29 155.21 3.29 5.6"/>';
                                break;
                            case 2:
                                echo '<polygon class="cls-1" points="108.11 5.6 200.03 5.6 200.03 94.45 109.32 94.45 108.11 5.6"/>';
                                break;
                            case 3:
                                echo '<rect class="cls-1" x="200.03" y="5.6" width="84.77" height="88.85"/>';
                                break;
                            case 4:
                                echo '<rect class="cls-1" x="284.79" y="5.6" width="92.77" height="88.85"/>';
                                break;
                            case 5:
                                echo '<rect class="cls-1" x="377.56" y="5.6" width="83.91" height="124.94"/>';
                                break;
                            case 6:
                                echo '<rect class="cls-1" x="377.56" y="130.53" width="83.91" height="60.6"/>';
                                break;
                            case 7:
                                echo '<rect class="cls-1" x="377.56" y="191.13" width="83.91" height="122.89"/>';
                                break;
                            case 8:
                                echo '<rect class="cls-1" x="377.56" y="314.02" width="83.91" height="81.45"/>';
                                break;
                            case 9:
                                echo '<rect class="cls-1" x="377.56" y="395.47" width="83.91" height="171.83"/>';
                                break;
                            case 10:
                                echo '<rect class="cls-1" x="377.56" y="567.3" width="83.91" height="80.17"/>';
                                break;
                            case 11:
                                echo '<rect class="cls-1" x="377.56" y="647.47" width="83.91" height="71.74"/>';
                                break;
                            case 12:
                                echo '<polygon class="cls-1" points="85.13 203.21 132.11 252.57 189.05 196.32 140.79 149.34 85.13 203.21"/>';
                                break;
                            case 13:
                                echo '<polygon class="cls-1" points="132.11 252.57 195.43 318.62 258.75 254.28 195.43 191.47 132.11 252.57"/>';
                                break;
                        }

                        if ($result_local->num_rows > 0) {
                            $negocio = $result_local->fetch_assoc();
                            ?>
                            <foreignObject 
                ...
                <g id="estacionamiento">
                    ...
                    <g>
                        ...
                        <rect class="cls-2" x="79.17" y="374.93" width="21.19" height="8.17" transform="translate(-81.01 28.95) rotate(-12.68)"/>
                    ...
                    <g>
                        ...
                        <rect class="cls-2" x="255.12" y="663.81" width="21.19" height="8.17" transform="translate(-399.25 940.85) rotate(-90.62)"/>
                        <rect class="cls-2" x="265.28" y="663.7" width="21.19" height="8.17" transform="translate(-388.86 950.9) rotate(-90.62)"/>
                    </g>
            ...
            <form id="assign-form">
                ...
                <select name="negocio_id" id="negocio_id" required>
                    ...
                    <?php foreach($negocios as $negocio): ?>
                        <option value="<?php echo $negocio['id']; ?>"><?php echo htmlspecialchars($negocio['nombre']); ?></option>
                    <?php endforeach; ?>
                </select>
